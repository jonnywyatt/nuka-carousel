...
var Carousel = _react2['default'].createClass({
  ...
  render: function render() {
    ...
    return _react2['default'].createElement(
      ...
      this.props.decorators && self.state.showControls ? this.props.decorators.map(function (Decorator, index) {
        return _react2['default'].createElement(
          'div',
          {
  ...
  setDimensions: function setDimensions(props) {
    ...
    var showControls = props.showHideControls ? (slideWidth + props.cellSpacing) * _react2['default'].Children.count(this.props.children) >= frameWidth : true;
